...
public class UsedCarsSearchPageActions {
	...
	public  UsedCarsSearchPageActions()
	{
		...
		PageFactory.initElements(SeleniumDriver_zeus.getDriver(), usedCarSearchPageLocators);
	}
	...
	public void selectCarMaker(String carBrand)
	{
		...
		SeleniumDriver_zeus.getDriver().findElement(By.xpath(".//*[@id='block-system-main']/div/div/div/div/div/form")).click();
	...
	public void selectPrice(String price)
	{
		...
		SeleniumDriver_zeus.getDriver().findElement(By.xpath(".//*[@id='price-max']")).click();
